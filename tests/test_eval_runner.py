...
def test_acceptance_gates_use_baseline_comparison() -> None:
    from app.evals.models import BaselineStats
    ...
    assert gates["roubaix_uses_graph_mode_less_than_graph_only"] is True
    assert gates["roubaix_routing_accuracy_gte_70pct"] is True
